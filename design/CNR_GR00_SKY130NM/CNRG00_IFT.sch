...
C {CNR_ATR_SKY130NM/CNRATR_PCH_8C12F0.sym} 830 -820 0 0 {name=xs1[15:0]}
...
C {CNR_ATR_SKY130NM/CNRATR_PCH_8C1F2.sym} 830 -720 0 0 {name=xc1[15:0]}
...
C {sky130_fd_pr/pnp_05v5.sym} 890 -320 0 1 {name=Q2
model=pnp_05v5_W3p40L3p40
m=1
spiceprefix=X
}
C {devices/opin.sym} 1170 -570 0 0 {name=p1 lab=VDA}
C {devices/opin.sym} 900 -610 0 0 {name=p2 lab=VD}
